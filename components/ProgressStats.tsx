...
const ProgressStats = () => {
  ...
  return (
    ...
    >
      <Text style={settingsStyles.sectionTitle}>İlerleme İstatikleri</Text>
      ...
      <View style={settingsStyles.statsContainer}>
        ...
        >
          ...
          <View>
            ...
            <Text style={settingsStyles.statLabel}>Tüm Görevler</Text>
          </View>
        </LinearGradient>
        ...
        >
          ...
          <View>
            ...
            <Text style={settingsStyles.statLabel}>Tamamlanan</Text>
          </View>
        </LinearGradient>
        ...
        >
          ...
          <View>
            ...
            <Text style={settingsStyles.statLabel}>Aktif</Text>
          </View>
        </LinearGradient>
      </View>
    </LinearGradient>
